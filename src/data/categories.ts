...
export const CATEGORIES: Record<CategoryId, CategoryConfig> = {
  alimentacao: { id: 'alimentacao', nome: 'AlimentaÃ§Ã£o', icon: 'UtensilsCrossed', cor: '#f97316', tipo: 'despesa' },
  ...
  saude: { id: 'saude', nome: 'SaÃºde', icon: 'HeartPulse', cor: '#ef4444', tipo: 'despesa' },
  educacao: { id: 'educacao', nome: 'EducaÃ§Ã£o', icon: 'BookOpen', cor: '#14b8a6', tipo: 'despesa' },
  salario: { id: 'salario', nome: 'SalÃ¡rio', icon: 'Banknote', cor: '#16a34a', tipo: 'receita' },
